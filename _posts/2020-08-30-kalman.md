...
To help me understand Kalman filtering while studying for quals, this cheat sheet condenses and complements the explanation of the Kalman filter in Bishop PRML ([pdf](http://users.isr.ist.utl.pt/~wurmd/Livros/school/Bishop%20-%20Pattern%20Recognition%20And%20Machine%20Learning%20-%20Springer%20%202006.pdf)) section 13.3. I wrote this as if I were about to implement it. (I didn't: there's already an open-source implementation, [pykalman](https://pykalman.github.io/), including all the functionality discussed herein.) I'm having trouble with math typesetting on the web, so here's the [markdown](https://ekernf01.github.io/files/kalman.md) and [pdf](https://ekernf01.github.io/files/kalman.pdf) of this post.
...
- Existing software. There is Python code out there for both EM and hidden state prediction: search PyKalman.
