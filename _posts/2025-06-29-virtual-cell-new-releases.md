...
For context, this post is part of a series on prediction of gene expression in response to genetic perturbations, which is often called virtual cell modeling.
