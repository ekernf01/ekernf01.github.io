...
- It's got enough space in the middle to carry up to 11kb of foreign DNA, which is handy for those trying to repurpose it. Wagner et al. inserted a 20bp random barcode (for lineage tracing) and a beta-actin promoter (so that the barcode gets transcribed into RNA and sequenced).
...
[<img src="{{ site.baseurl }}/_posts/trees_compare1.png" alt="Clonal (left) and Waddington (right) trees" style="width: 400px;"/>]({{ site.baseurl }}/_posts/trees_compare1.png)
